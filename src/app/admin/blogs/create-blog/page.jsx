...
const CreateBlog = () => {
    ...
    return (
        <div className="p-4 w-full flex m-auto h-full max-w-[1200px]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-6 w-full ">
                ...
                <button
                    className="bg-slate-800 p-2 mt-3 mb-6 rounded outline-none border border-transparent focus:border-slate-600 hover:bg-blue-700 duration-150"
                    type="submit"
                    disabled={isLoading}
                >
